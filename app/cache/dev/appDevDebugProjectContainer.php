...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'orderly_pay_pal_ipn' => 'getOrderlyPayPalIpnService',
        ...
        $this->aliases = array(
            ...
            'paypal_ipn.driver.object_manager' => 'doctrine.orm.default_entity_manager',
            'scantasydat' => 'fos_facebook.api',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Console2/Realesta/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Console2/Realesta/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/Console2/Realesta/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Console2/Realesta/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'mrmnwzje', 'host' => 'horton.elephantsql.com', 'port' => 5432, 'user' => 'mrmnwzje', 'password' => 'l78GhP8A5aN1Upp0iCiu76_MYMtXmG49', 'charset' => 'UTF8', 'driver' => 'pdo_pgsql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_6f9aae6e20b999331606ddeaad2bdfb2');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6f9aae6e20b999331606ddeaad2bdfb2');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_6f9aae6e20b999331606ddeaad2bdfb2');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\Console2\\Realesta\\vendor\\orderly\\src\\Orderly\\PayPalIpnBundle\\Entity', 1 => 'C:\\Console2\\Realesta\\src\\Drivrrr\\ScanBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\Console2\\Realesta\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity'));
        $f->setGlobalBasename('mapping');

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($e, 'Orderly\\PayPalIpnBundle\\Entity');
        $g->addDriver($e, 'Drivrrr\\ScanBundle\\Entity');
        $g->addDriver($f, 'FOS\\UserBundle\\Entity');
        $g->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('C:\\Console2\\Realesta\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('OrderlyPayPalIpnBundle' => 'Orderly\\PayPalIpnBundle\\Entity', 'ScanBundle' => 'Drivrrr\\ScanBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('C:/Console2/Realesta/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Console2/Realesta/app/Resources');
    }
    ...
    {
        return $this->services['fos_facebook.api'] = new \FOS\FacebookBundle\Facebook\FacebookSessionPersistence(array('appId' => '477116279031840', 'secret' => '8a6b42ff223841f5e2dc7712ffb94b21', 'cookie' => true, 'domain' => NULL), $this->get('session'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Drivrrr\\ScanBundle\\Entity\\UserAcc');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('test.email.sloth@gmail.com' => 'Admin'), 'resetting' => array('test.email.sloth@gmail.com' => 'Admin'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Drivrrr\\ScanBundle\\Entity\\UserAcc');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Drivrrr\\ScanBundle\\Entity\\UserAcc');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Drivrrr\\ScanBundle\\Entity\\UserAcc');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Drivrrr\\ScanBundle\\Entity\\UserAcc');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Console2/Realesta/app/logs/dev.log', 100, true);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Drivrrr\ScanBundle\Security\User\Provider\FacebookProvider A Drivrrr\ScanBundle\Security\User\Provider\FacebookProvider instance.
     */
    protected function getMy_Facebook_UserService()
    {
        return $this->services['my.facebook.user'] = new \Drivrrr\ScanBundle\Security\User\Provider\FacebookProvider($this->get('fos_facebook.api'), $this->get('fos_user.user_manager'), $this->get('validator'), $this);
    }

    /**
     * Gets the 'orderly_pay_pal_ipn' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Orderly\PayPalIpnBundle\Ipn A Orderly\PayPalIpnBundle\Ipn instance.
     */
    protected function getOrderlyPayPalIpnService()
    {
        return $this->services['orderly_pay_pal_ipn'] = new \Orderly\PayPalIpnBundle\Ipn($this, $this->get('doctrine.orm.default_entity_manager'), 'Orderly\\PayPalIpnBundle\\Entity\\IpnLog', 'Orderly\\PayPalIpnBundle\\Entity\\IpnOrders', 'Orderly\\PayPalIpnBundle\\Entity\\IpnOrderItems');
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Console2/Realesta/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Console2/Realesta/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Console2/Realesta/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Drivrrr\\ScanBundle\\Entity\\UserAcc' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'FOS\\UserBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.public' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_PublicService()
    {
        ...
        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($d, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, 'scan_welcome'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\CookieClearingLogoutHandler(array('fbs_477116279031840' => array('path' => '/', 'domain' => 'http://localhost:8000/'))));

        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($l, array('default_target_path' => 'scan_home', 'login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $n->setProviderKey('public');

        $o = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($l, array('default_target_path' => 'scan_home', 'login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $o->setProviderKey('public');

        return $this->services['security.firewall.map.context.public'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($d, array(0 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b, 1 => $c)), 1 => $b, 2 => $c, 3 => $k), 'public', $a, $e), 2 => $m, 3 => new \FOS\FacebookBundle\Security\Firewall\FacebookListener($d, $h, $i, $l, 'public', $n, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $l, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'fos_facebook_security_check', 'app_url' => 'http://www.facebook.com/apps/application.php?id=347365422055677', 'server_url' => 'http://localhost:8000/app_dev.php', 'use_forward' => false, 'require_previous_session' => true, 'display' => 'page', 'create_user_if_not_exists' => false, 'redirect_to_facebook_login' => true), $a, $e), 4 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($d, $h, $i, $l, 'public', $o, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $l, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $e), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '521daca742164', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $this->get('security.access.decision_manager'), $j, $h, $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $l, 'public', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $l, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Console2/Realesta/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Console2/Realesta/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Console2/Realesta/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Console2/Realesta/app/cache/dev/sessions');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $instance->setUsername('test.email.sloth@gmail.com');
        $instance->setPassword('wearehandsome');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Console2/Realesta/app', 'UTF-8');
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('public', 'fos_user_security_logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/Console2/Realesta/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Console2/Realesta/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Console2/Realesta/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\orderly\\src\\Orderly\\PayPalIpnBundle/Resources/views', 'OrderlyPayPalIpn');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Console2\\Realesta\\src\\Drivrrr\\ScanBundle/Resources/views', 'Scan');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\friendsofsymfony\\facebook-bundle\\FOS\\FacebookBundle/Resources/views', 'FOSFacebook');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Console2/Realesta/app/Resources/views');
        $instance->addPath('C:\\Console2\\Realesta\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Console2/Realesta/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Console2/Realesta/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Console2/Realesta/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\Console2\\Realesta\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\Console2\\Realesta\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'C:\\Console2\\Realesta\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Console2/Realesta/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Console2/Realesta/app/cache/dev',
            'kernel.logs_dir' => 'C:/Console2/Realesta/app/logs',
            'kernel.bundles' => array(
                'OrderlyPayPalIpnBundle' => 'Orderly\\PayPalIpnBundle\\OrderlyPayPalIpnBundle',
                ...
                'ScanBundle' => 'Drivrrr\\ScanBundle\\ScanBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'mrmnwzje',
            'database_user' => 'mrmnwzje',
            'database_password' => 'l78GhP8A5aN1Upp0iCiu76_MYMtXmG49',
            ...
            'orderly.paypalipn.islive' => false,
            'orderly.paypalipn.email' => 'test.email.sloth-facilitator@gmail.com',
            'orderly.paypalipn.url' => 'https://www.sandbox.paypal.com/cgi-bin/webscr',
            'orderly.paypalipn.debug' => true,
            'paypal_ipn.class.ipn_log' => 'Orderly\\PayPalIpnBundle\\Entity\\IpnLog',
            'paypal_ipn.class.ipn_order_items' => 'Orderly\\PayPalIpnBundle\\Entity\\IpnOrderItems',
            'paypal_ipn.class.ipn_orders' => 'Orderly\\PayPalIpnBundle\\Entity\\IpnOrders',
            'orderly_pay_pal_ipn.class' => 'Orderly\\PayPalIpnBundle\\Ipn',
            ...
            'debug.container.dump' => 'C:/Console2/Realesta/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/Console2/Realesta/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Console2\\Realesta\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'C:\\Console2\\Realesta\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'C:\\Console2\\Realesta\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/Console2/Realesta/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Console2/Realesta/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Console2/Realesta/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'test.email.sloth@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'wearehandsome',
            ...
            'assetic.cache_dir' => 'C:/Console2/Realesta/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Console2/Realesta/app/../web',
            'assetic.write_to' => 'C:/Console2/Realesta/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Console2/Realesta/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Drivrrr\\ScanBundle\\Entity\\UserAcc',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'test.email.sloth@gmail.com' => 'Admin',
            ),
            ...
            'fos_facebook.app_id' => '477116279031840',
            'fos_facebook.secret' => '8a6b42ff223841f5e2dc7712ffb94b21',
